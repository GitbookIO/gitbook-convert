...
var Chapter = require('./types/chapter2');
...
DocbookConverter.prototype.parseChapters = function() {
    ...
    // console.log(that.chapters[0].getSiblings());

    // Create README from remaining HTML
    var readme = new Chapter();
    readme.content = that._html;
    readme.level = 0;
    readme.title = 'Introduction';
    readme.path = '';
    readme.filename = 'README.'+'md';
    readme.filepath = readme.filename;
...
DocbookConverter.prototype.writeSummary = function() {
...
DocbookConverter.prototype.writeFiles = function(first_argument) {
    var that = this;
