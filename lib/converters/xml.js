...
DocbookConverter.prototype.toHTML = function() {
    ...
    var output = path.resolve(path.dirname(that.filename), that.documentTitle)+'.html';
    var resources = path.resolve(__dirname, '../../resources/docbook/xhtml5/docbook.xsl');
    var stylesheet = 'docbook.css';
...
DocbookConverter.prototype.parseChapters = function() {
    ...
    var readme = Readme.generate('md', that.documentTitle, that._projectFolder, that._html);
    readme.setTitle();
