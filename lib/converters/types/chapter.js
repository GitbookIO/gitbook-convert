...
Chapter.generateReadme = function(ext, documentTitle, rootDir, content) {
    var readme = new Chapter(rootDir);

    var defaultContent = '<h1>'+documentTitle+'</h1>'+
        '<p>This file serves as your book\'s preface, a great place to describe your book\'s content and ideas.</p>';
